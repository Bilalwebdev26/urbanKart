  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between">
        <h2 className="poppins-font font-bold text-2xl mt-2">Flash Sales</h2>
        {/* <div className="flex items-center gap-4 text-2xl">
          <FaRegHandPointLeft  className="bg-gray-200 w-15 h-10 rounded-full"/>
          <FaRegHandPointRight />
        </div> */}
